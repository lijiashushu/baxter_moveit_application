...
#include <Eigen/Eigen>
#include "baxter_moveit_application/DualCBiRRT_Astar/backward.hpp"
#include "baxter_moveit_application/DualCBiRRT_Astar/node.h"
...
{	
	...
	protected:
		...
		Eigen::Matrix<double, 26,4> neighbor_dir;

		GridNodePtr terminatePtr;
		std::multimap<double, GridNodePtr> openSet;

		double getHeu(GridNodePtr node1, GridNodePtr node2);
        double getHeuMultiTarget(GridNodePtr node1, const std::vector< Eigen::Vector3d > & end_pts);
	...
	public:
        ...
        bool AstarGraphSearchMultiTarget(const Eigen::Vector3d start_pt, const std::vector< Eigen::Vector3d > & end_pts);
