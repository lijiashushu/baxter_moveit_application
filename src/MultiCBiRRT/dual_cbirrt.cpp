...
bool DualCBiRRT::plan_task_space_dir_multi_tree(std::vector<robot_state::RobotState> & goal_state, std::vector<robot_state::RobotState> & start_state, planning_scene::PlanningScenePtr& planning_scene_ptr, const std::string & planning_group_name, const robot_state::JointModelGroup* planning_group, const robot_state::JointModelGroup* slave_group){
