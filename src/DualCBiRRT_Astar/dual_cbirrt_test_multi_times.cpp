...
//    std::vector<double> slave_test_goal_value = {-0.485412,0.487359,1.66579,1.6767,-0.522427,1.24843,-1.42944};//narrow障碍物的目标右臂位置
    ...
    out_file1.open("/home/lijiashushu/ros_ws/src/baxter_moveit_application/draw_data/adjust_dir_no.csv", std::ios::out | std::ios::trunc);
    ...
    out_file2.open("/home/lijiashushu/ros_ws/src/baxter_moveit_application/draw_data/adjust_dir_yes.csv", std::ios::out | std::ios::trunc);
    ...
    for(int ii = 0; ii<10; ii++){
        ...
        if(my_planner2.plan_adjust_extend_dir(goal_state, start_state, planning_scene_for_operate, "left_arm", planning_group, slave_group)){
